...
namespace ProjetFantaMelanie
{
    public sealed partial class MonDialogueAdherent : ContentDialog
    {
        ...
        public MonDialogueAdherent()
        {
            ...
            tbxDateNaisAjout.MaxYear = new DateTimeOffset(new DateTime(2006, 1, 1));
            // Date par defaut
            tbxDateNaisAjout.SelectedDate = new DateTimeOffset(new DateTime(2006, 1, 1));
        }
        ...
        private void ContentDialog_PrimaryButtonClick(ContentDialog sender, ContentDialogButtonClickEventArgs args)
        {
            ...
            if (valide == true)
            {
                Adherent unAdherent = new Adherent()
                {
                    ...
                    DateNaissance = tbxDateNaisAjout.Date.ToString("d"),
