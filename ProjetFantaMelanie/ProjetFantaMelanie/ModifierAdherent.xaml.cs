    ...
    public sealed partial class ModifierAdherent : Page
    {
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            if (e.Parameter is not null)
            {
                ...
                Adherent unAdherent = SingletonListe2.getInstance().getAdherent(index);

                tbxNomDetail.Text = unAdherent.Nom;
                tbxPrenomDetail.Text = unAdherent.Prenom;
                tbxDateNaisDetail.Text = unAdherent.DateNaissance;
                tbxAdresseDetail.Text = unAdherent.Adresse.ToString();
        ...
        private async void btnModifier_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (valide == true)
            {
                ...
                {
                    Nom = tbxNomDetail.Text,
                    Prenom = tbxPrenomDetail.Text,
                    DateNaissance = tbxDateNaisDetail.Text,
                    Adresse = tbxAdresseDetail.Text
                };
